...
for H_Layer = H_Values
    ...
    %     end
        ...
        W1 = W1 + nu * Grad1 - gam*W1;
        W2 = W2 + nu * Grad2 - gam*W2;
    ...
    sprintf('Q5B Batch Learning, Sigmoid, H = %d: Train err: %f, Test err: %f', H_Layer, errors_train(1,checkpoints),errors_test(1,checkpoints))
