...
trainset_name = 'trainset\subset';
testset_name = 'testset\subset';
TrainSet = [];
TestSet = [];

for i = 0:5
    current = strcat(trainset_name,int2str(i));
...
% sgtitle('Q5 a) The 16 highest variance principal components derived by PCA.');
